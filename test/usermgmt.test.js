...
describe('Test Suite for User Model ', function() {
    ...
    it('should validate if grid is not defined as required id false,which means its optional', function() {
        var m = new Usr({
            google : {
                id : '102010',
                token: 'fhdhgretvsg',
    ...
    it('should validate even if missions is not defined as required id false,which means its optional', function() {
        var m = new Usr({
            google : {
                id : '102010',
                token: 'fhdhgretvsg',
