  ...
  function openLeftNav() {
    if(mq.matches || mq_nexus_5x.matches || iphone6pluspotrait.matches ){ 
      ...
      document.getElementById("input-search").style.fontSize = "16px";
      document.getElementById("left-menu-item1").style.fontSize = "16px";
      document.getElementById("left-menu-item2").style.fontSize = "16px";
      document.getElementById("left-menu-item3").style.fontSize = "16px";
      document.getElementById("left-menu-item4").style.fontSize = "16px";
    }
  }
  ...
  function openQwidgetList() {
    var list = document.getElementById("widgettops");
    if (list.style.display ===  "none"){
      $('#qwidget-add').removeClass('glyphicon glyphicon-menu-down').addClass('glyphicon glyphicon-menu-up');
        list.style.display = "block";
    }else{
       $('#qwidget-add').removeClass('glyphicon glyphicon-menu-up').addClass('glyphicon glyphicon-menu-down');
        list.style.display = "none";
    }
  }

  function openQwidgetMenu() {
    var list = document.getElementById("qwidgetMenu");
    if (list.style.display ===  "none"){
      $('#qwidget-arrow').removeClass('glyphicon glyphicon-menu-down').addClass('glyphicon glyphicon-menu-up');
      list.style.display = "block";
    }else{
      $('#qwidget-arrow').removeClass('glyphicon glyphicon-menu-up').addClass('glyphicon glyphicon-menu-down');
      list.style.display = "none";
    }
  }
