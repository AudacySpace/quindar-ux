    ...
    QUINDAR.addGroundWidget = function(){
		...
		$('.grid-stack').data('gridstack').addWidget($(
            ...
            <button type="button" class="glyphicon glyphicon-trash" aria-label="Close" id="removespan">\
	       	...
	       	<div class="svg-container" id="divplot'+QUINDAR.gcount+'"></div></div></div>'),0,0,6,5);
    ...
    QUINDAR.addTableWidget = function(){
        ...
        if(width<=1280){
            ...
            $(document).on('click', '#removespan', function(e) {
             ...
             griddata = '<div data-gs-min-width="6" data-gs-min-height="6"><div class="panel panel-primary grid-stack-item-content" id="tabletextqwidget'+QUINDAR.counter+'">'
                        +'<div class="panel-heading">'
                        +'<button type="button" class="glyphicon glyphicon-cog pull-right" id="settings" onclick="openSettings('+QUINDAR.counter+')">'
                        +'</button>'
                        +'<div style="display:none" id="settings-menu'+QUINDAR.counter+'" class="settings-menu">'
        ...
        QUINDAR.addIdTable = function(e){
            QUINDAR.icount++;
                grid = '<div><div class="panel panel-primary filterable grid-stack-item-content">'
                        +'<div class="panel-heading ">'
                        +'<button type="button" class="glyphicon glyphicon-cog pull-right" id="settings" onclick="openTableIdSettings('+QUINDAR.icount+')">'
                        +'</button>'
                        +'<div style="display:none" id="id-settings-menu'+QUINDAR.icount+'" class="settings-menu">'
                        +'<button type="button" class="glyphicon glyphicon-edit" data-toggle="modal" data-target="#myModalNorm">'
                        +'</button>'
                        +'<button type="button" class="glyphicon glyphicon-trash" aria-label="Close" id="removespan">'
                        +'</button>'
                 ...
                 $('.grid-stack').data('gridstack').addWidget($(grid),0,0,6,6);
                 $(document).on('click', '#removespan', function(e) {
                    console.log("table widget deleted");
                    e.target.closest("div").parentElement.parentElement.remove();
                 });
