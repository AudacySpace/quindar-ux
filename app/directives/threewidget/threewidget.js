app
.directive('threewidget', function() {
  	return { 
    	restrict: 'E',
		scope: {
			assimpUrl: "=assimpUrl"
...
app.controller('threeController', function ($scope) {
	 $scope.assimpModelUrl = "./directives/threewidget/models/jeep1.ms3d.json";

	$scope.changeModel = function() {
		if ($scope.assimpModelUrl == "../directives/threewidget/models/interior.3ds.json") {
		return	$scope.assimpModelUrl = "../directives/threewidget/models/jeep1.ms3d.json";
		}
		else {
