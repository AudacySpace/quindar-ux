var app = angular.module('app', 
	...
	'cgPrompt', 'hc.marked','ui.select','ngStorage','ngAria','ngAnimate','angularjs-dropdown-multiselect','as.sortable','angularScreenfull','angular-detect-browser'],function($mdThemingProvider){
